<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="BookStore.UserProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <div class="card mx-auto" style="width: 25rem;">
            ...
            <center>
                <asp:Image ID="Image1" src="Uploaded/q.png" runat="server" Height="224px" Width="218px" class="card-img-top" />
            </center>
